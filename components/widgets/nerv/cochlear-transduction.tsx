      ...
      <div className="grid gap-4 lg:grid-cols-[minmax(0,1fr)_360px] lg:items-start">
        <section className="ph-panel ph-chart-stage p-4" aria-label="Cochlear transduction pathway">
          ...
          <p className="ph-clay-well mt-3 px-3 py-2 text-xs leading-relaxed text-ph-muted">
            ...
            Click each station as sound becomes signal: eardrum → ossicles (impedance matching) → cochlear fluid → basilar membrane, which is TONOTOPIC (base codes high pitch, apex low) → hair cells → CN VIII. Outer-ear or ossicle problems give conductive loss; hair-cell or nerve problems give sensorineural loss.
          </p>
        </section>
