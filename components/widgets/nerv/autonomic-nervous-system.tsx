      ...
      <div className="grid gap-4 lg:grid-cols-[minmax(0,1fr)_360px] lg:items-start">
        <section className="ph-panel ph-chart-stage p-4" aria-label="Autonomic target map">
          ...
          <p className="ph-clay-well mt-3 px-3 py-2 text-xs leading-relaxed text-ph-muted">
            ...
            Click a target organ to compare the two divisions and their receptors. Sympathetic and parasympathetic usually oppose each other, but watch the exceptions: sweat glands are sympathetic yet cholinergic, the adrenal medulla is a modified sympathetic ganglion, and most blood vessels take sympathetic tone only.
          </p>
        </section>
